...
@Component({
    selector: 'app-loan-principal-overdue-fee-summary',
    imports: [
    ...
    providers: [DatePipe],
    templateUrl: './loan-principal-overdue-fee-summary.component.html',
    styleUrl: './loan-principal-overdue-fee-summary.component.scss',
})
